...
*Next up: Lab 02 — Implementation of SQL Commands*
![docker-running.png](./images/docker-running.png)

![azure-connection-form.png](./images/azure-connection-form.png)

![azure-connected-sidebar.png](./images/azure-connected-sidebar.png)

![cover.png](./images/cover.png)

![northwind-github.png](./images/northwind-github.png)
![docker-running.png](./images/docker-running.png)
...
![northwind-script-done.png](./images/northwind-script-done.png)

![northwind-messages.png](./images/northwind-messages.png)

![foreign-keys.png](./images/foreign-keys.png)

![list-tables.png](./images/list-tables.png)

![dbeaver-connection.png](./images/dbeaver-connection.png)

![dbeaver-schema.png](./images/dbeaver-schema.png)

![dbeaver-er-diagram.png](./images/dbeaver-er-diagram.png)

![northwind-er-full.png](./images/northwind-er-full.png)
